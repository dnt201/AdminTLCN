...
const Pagination: React.FC<iLazy> = (props) => {
    const { order, pageNumber, totalElement, size, changePageNumber, loading } = props;
        ...
        <div className='flex flex-col items-center'>
            <div className='flex w-full justify-center items-center p-2 text-primary'>
                <button
                    className={
                        ...
                        'disabled:text-gray-c6 disabled:cursor-not-allowed disabled:bg-gray-c3 disabled:border-white'
                    }
            ...
            '
                ...
                <button
                    ...
                    disabled={curPage === maxPage || maxPage === 1 || maxPage === 0 || loading}
                    onClick={() => {
