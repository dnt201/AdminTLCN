...
const BlogDetail = () => {
    ...
    const checkOwner = async (post: iPostDetail) => {
        if (post !== null) {
    ...
    return (
        <div ref={divRef} className='bg-white min-h-[calc[100vh-52px]] flex flex-col text-bg'>
            {post ? (
                <>
                    <div className='flex flex-col'>
                        ...
                        <div className=' max-w-[1016px]   w-full mx-auto'>
                            ...
                            <div id='comment-post-section'>
                                <Comment idPost={post.id} isOwner={isOwner} status={post.status} />
                            </div>
                        </div>
                    </div>
                </>
